  ...
  export const projects: Array<ProjectItemType> = [
    {
      ...
      link: { href: 'github.com/xtremislv/textify-VQA', label: 'Textify-VQA' },
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/career-crafter-interview-service', label: 'Career Crafters' },
      category: ['AI/ML software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/banking_chatbot', label: 'Banking Chatbot' },
      category: ['Chatbot'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/UrbanGraphNet', label: 'UrbanGraphNet' },
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/CraterGraph', label: 'CraterGraph' },
      category: ['CV Model'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/PanScope-Intelligent-PAN-Card-Data-Extractor', label: 'PanScope' },
      category: ['AI/ML software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/Reinforcement-Learning-Based-Distributed-Server-Load-Balancer', label: 'Load Balancer' },
      category: ['RL model'],
    ...
    },
    {
      ...
      link: { href: 'chat-app-rnp5.onrender.com/', label: 'chat-app' },
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/campus-food-delivery-web-service', label: 'Campus Delivery System' },
      category: ['Website'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/MultiTaskNLP-Unified-Model-for-NER-Sentiment-Emotion-Analysis', label: 'MultiTaskNLP' },
      category: ['AI/ML Software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/QuoteMind-Semantic-Quote-Explorer', label: 'QuoteMind' },
      category: ['AI/ML Software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/LMM-ConceptExplainer-VQA', label: 'LMM-ConceptExplainer-VQA' },
      category: ['AI/ML Software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/LMM-ConceptExplainer-VQA', label: 'Omniglot-MetaLearn' },
      category: ['AI/ML Software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/ZeroShot-NewsClassifier', label: 'ZeroShot-NewsClassifier' },
      category: ['AI/ML Software'],
    ...
    },
    {
      ...
      link: { href: 'github.com/xtremislv/label-AI', label: 'Label_ai_app' },
  ...
  export const githubProjects: Array<ProjectItemType> = [
    {
      ...
      link: { href: 'github.com/xtremislv/polyphony-interactive-transfer-learning-framework', label: 'polyphony' },
      gitStars: 2,
      gitForks: 1
    },
    {
      ...
      link: { href: 'github.com/xtremislv/deep-guidance-nerve-segmentation', label: 'deep-guidance-nerve-segmentation' },
      gitStars: 2,
      gitForks: 1
    },
    {
      ...
      link: { href: 'github.com/xtremislv/knowledge-distillation', label: 'Knowledge Distillation implementation on TinyBert' },
      gitStars: 2,
      gitForks: 1
    },
    {
      ...
      link: { href: 'github.com/xtremislv/smoke_detection', label: 'smoke_detection' },
      gitStars: 2,
      gitForks: 1
    },
    {
      ...
      link: { href: 'github.com/xtremislv/xtremislv.github.io', label: 'portfolio Website' },
      gitStars: 2,
      gitForks: 1
    },
    {
      ...
      link: { href: 'github.com/xtremislv/video_cap', label: 'Video-Captioning' },
      gitStars: 2,
      gitForks: 1
    },
  ]
