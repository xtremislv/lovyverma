...
export default function Feed() {
  ...
  const feedUrl = `https://tinyurl.com/2rb8efut`
  ...
  return (
    <div className="rounded-2xl border p-6 border-muted shadow-sm">
      <h2 className="flex text-sm font-semibold">
        ...
        <span className="ml-3">Know More about me</span>
      </h2>
      ...
      <div className="mt-4 flex gap-4">
        ...
        <Button 
          onClick={() => window.open(`https://drive.google.com/file/d/1lDQ1SgYW8FFS6CjANJFwxf6eAZJU_BIc/view?usp=sharing`, '_blank')} 
